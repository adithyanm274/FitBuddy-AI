...
# Corrected import – models live inside user_module
from user_module.models import UserProfile, GeneratedWorkout, ChatMessage, FoodRecommendation
from user_module.forms import FeedbackForm, UserProfileForm
import json
import os
import re
import logging
